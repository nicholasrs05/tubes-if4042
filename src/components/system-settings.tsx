                        ...
                        <div className="min-w-0 flex-1 space-y-4 border-2">
                            ...
                            <div className="flex flex-col gap-4 lg:flex-row lg:gap-10">
                                <div className="flex items-center gap-1">
                                    <Label className="text-base font-medium leading-none"><i>&beta;</i> =</Label>
                                    <Input
                                        className="w-15 text-center"
                                        type="number"
                                        value={systemSettings.rocchioBetaConstant}
                                        onChange={(e) => onSettingsChange("rocchioBetaConstant", parseFloat(e.target.value))}
                                    />
                                </div>
                                <div className="flex items-center gap-1">
                                    <Label className="text-base font-medium leading-none"><i>&gamma;</i> =</Label>
                                    <Input
                                        className="w-15 text-center"
                                        type="number"
                                        value={systemSettings.rocchioGammaConstant}
                                        onChange={(e) => onSettingsChange("rocchioGammaConstant", parseFloat(e.target.value))}
                                    />
                                </div>
                            </div>
                        </div>
